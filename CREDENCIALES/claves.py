...
curl -X POST -d "nombre=paulinacarre&password=clave123" http://localhost:5800/login
curl -X POST -d "nombre=paulinacarre&password=clave123" http://127.0.0.1:5800/registrar
